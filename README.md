...
* [플레이 스토어 개발자 사이트](https://developer.android.com/about/dashboards?hl=ko)
* [플레이 스토어 공식 개발자 사이트](https://android-developers.googleblog.com/) 
* [안드로이드 스튜디오 단축기 모음](https://nittaku.tistory.com/60)
* [안드로이드 개발자 참고 사이트 모음](http://sunphiz.me/wp/archives/1567)
* [Json To model](https://app.quicktype.io/)
* [안드로이드 Gradle](https://developer.android.com/studio/releases/gradle-plugin)
* [안드로이드 ux/ui 모음](https://github.com/wasabeef/awesome-android-ui)
...
* [블로그 2 : realm - Jake Wharton](https://academy.realm.io/kr/posts/droidcon-jake-wharton-simple-http-retrofit-2/)
